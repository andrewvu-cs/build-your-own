...
function errorResult(tags = [], message = "") {
    return {
        payload: null,
...
}const PullstateContext = React__default.createContext(null);
const PullstateProvider = ({ instance, children, }) => {
    return React__default.createElement(PullstateContext.Provider, { value: instance }, children);
};
let singleton = null;
const clientStores = {
...
function createPullstateCore(allStores = {}) {
